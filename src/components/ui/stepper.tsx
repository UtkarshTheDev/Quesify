    ...
    return (
        ...
        >
            <div
                ...
                className={cn(
                    "group/step flex items-center gap-2 group-data-[orientation=horizontal]/stepper-nav:flex-row group-data-[orientation=vertical]/stepper-nav:flex-col",
                    className,
                )}
                data-state={state}
...
function StepperTrigger({
    ...
    return (
        <button
            ...
            className={cn(
                "cursor-pointer p-2 focus-visible:border-ring focus-visible:ring-ring/50 inline-flex items-center gap-3 rounded-full outline-none focus-visible:z-10 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-60",
                className,
            )}
...
function StepperIndicator({
    ...
    return (
        <div
            ...
            data-state={state}
            className={cn(
                "flex items-center justify-center shrink-0 rounded-full border border-border bg-background",
                state === "active" &&
                    "bg-orange-500 border-orange-500 text-white",
                state === "completed" &&
                    "bg-orange-500 border-orange-500 text-white",
                state === "inactive" && "bg-orange-100 text-orange-600",
                className,
            )}
